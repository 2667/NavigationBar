...
- (void)viewDidLoad {
    ...
    [self zt_setNavBarBarTintColor:[UIColor whiteColor]];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if (offsetY > NAVBAR_COLORCHANGE_POINT)
    {
        ...
        if (alpha > 0.5) {
            [self zt_setNavBarTintColor:[UIColor colorWithRed:0 green:0.478431 blue:1 alpha:1.0]];
            [self zt_setNavBarTitleColor:[UIColor blackColor]];
