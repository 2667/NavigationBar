...
- (void)setNavBarAppearence
{
    ...
    // 设置导航栏默认的背景颜色
    [UIColor zt_setDefaultNavBarBarTintColor:MainNavBarColor];
    // 设置导航栏所有按钮的默认颜色
    [UIColor zt_setDefaultNavBarTintColor:[UIColor whiteColor]];
    // 设置导航栏标题默认颜色
    [UIColor zt_setDefaultNavBarTitleColor:[UIColor whiteColor]];
    // 统一设置状态栏样式
    [UIColor zt_setDefaultStatusBarStyle:UIStatusBarStyleLightContent];
